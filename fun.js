  ...
  return (
    <div className="header">
      <div className="logo-container">
          <img className="logo" src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png" alt="logo_image" />
      </div>
    ...
    <div className="res-card">
        ...
        src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.data.cloudinaryImageId}
         />
          ...
          <h4>Cost : {resData.data.costForTwo / 100}</h4>
          <h4>Delivery Time : {resData.data.deliveryTime}</h4>
    </div>
    );
};
